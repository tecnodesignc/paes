    ...
    public function getItemsBy(bool|object $params = false): Collection|LengthAwarePaginator
    {
        ...
        if (isset($params->filter)) {
            ...
            if (isset($filter->company_id)) {
                $query->where('documentable_id', $filter->documentable_id);
            }
            if (isset($filter->documentable_type)) {
                $query->where('documentable_type', $filter->documentable_type);
            }
