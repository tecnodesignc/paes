...
class ApiKeysController extends Controller
{
    ...
    {
        $oldToken=$this->userToken->findByAttributes(['user_id'=>$user_id]);
        $this->userToken->destroy($oldToken);
        $this->userToken->generateFor($user_id);
        $tokens = $this->userToken->allForUser($user_id);
