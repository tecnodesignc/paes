...
<script>
    ...
    if (typeof window.openMediaWindowMultipleOld === 'undefined') {
        ...
        window.openMediaWindowMultipleOld = function (event, zone) {
            ...
            window.open(Encore.mediaGridSelectUrl, '_blank', 'menubar=no,status=no,toolbar=no,scrollbars=yes,height=500,width=1000');
        };
    }
