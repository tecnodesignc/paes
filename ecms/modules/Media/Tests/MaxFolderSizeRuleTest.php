...
final class MaxFolderSizeRuleTest extends MediaTestCase
{
    ...
    {
        $this->app['config']->set('encore.media.config.max-total-size', 1000); // Mocked folder size: 510
    ...
    {
        $this->app['config']->set('encore.media.config.max-total-size', 50); // Mocked folder size: 510
