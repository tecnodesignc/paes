...
(function () {
  ...
  function setLanguage(lang) {
    document.getElementsByClassName("header-lang-img").forEach(function (el) {
      if (el) {
        switch (lang) {
          case "en":
            el.src = "themes/encore/images/flags/us.jpg";
            break;
          case "sp":
            el.src = "themes/encore/images/flags/spain.jpg";
            break;
          case "gr":
            el.src = "themes/encore/images/flags/germany.jpg";
            break;
          case "it":
            el.src = "themes/encore/images/flags/italy.jpg";
            break;
          case "ru":
            el.src = "themes/encore/images/flags/russia.jpg";
            break;
          default:
            el.src = "themes/encore/images/flags/us.jpg";
            break;
  ...
  function getLanguage() {
    ...
    request.open("GET", "/themes/encore/lang/" + language + ".json");
  ...
  function changeDirection(id) {
    if (
      ...
      document
        ...
        .setAttribute("href", "themes/encore/css/bootstrap.min.css");
      document
        .getElementById("app-style")
        .setAttribute("href", "themes/encore/css/app.min.css");
      sessionStorage.setItem("is_visited", "layout-direction-ltr");
    } else if (
      ...
      document
        .getElementById("bootstrap-style")
        .setAttribute("href", "themes/encore/css/bootstrap-rtl.min.css");
      document
        .getElementById("app-style")
        .setAttribute("href", "themes/encore/css/app-rtl.min.css");
