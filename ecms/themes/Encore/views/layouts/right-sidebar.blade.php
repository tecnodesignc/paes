...
<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            ...
            <h6 class="mt-4 mb-3 pt-2">Ayuda Visual</h6>
            ...
            <div  style="visibility: hidden">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label"
                           for="layout-position-scrollable">@lang('translation.Scrollable')</label>
                </div>
                ...
                <div id="sidebar-setting">
                    ...
                    <div class="form-check sidebar-setting">
                        ...
                        <label class="form-check-label"
                               for="sidebar-size-small">@lang('translation.Small_(Icon_View)') </label>
                    </div>
