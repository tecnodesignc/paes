    ...
    @switch($field->type)
            ...
            <div class="row mt-3">
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="btn-group border border-primary" role="group" aria-label="Basic radio toggle button group">
                        <input type="radio" class="btn-check" autocomplete="off" value="1"
                                {{$field->value === 1 ? 'checked' : ''}}>
                        <label class="btn btn-outline-dark mb-0">Si</label>

                        <input type="radio" class="btn-check" autocomplete="off" value="0"
                ...
                <div class="col-lg-3 col-md-12">
                    <textarea class="form-control" rows="2" cols="50", placeholder="Agregar un comentario">{{$field->comment??''}}</textarea>
                </div>
            </div>
            @break
        ...
        @case(0)
            <div class="row mt-3">
                <div class="col-lg-12 col-md-12">
                    <h5 class="text-truncate font-size-18 mb-1">{{$field->label}}</h5>
                    <input type="text" value="{{$field->value}}" class="form-control">
                </div>
            </div>
            @break
        ...
        @case(1)
            <div class="row mt-3">
                <div class="col-lg-12 col-md-12">
                    <h5 class="text-truncate font-size-18 mb-1">{{$field->label}}</h5>
                    <textarea class="form-control" rows="5" cols="50">{{$field->value ?? ''}}</textarea>
                </div>
            </div>
            @break
        ...
        @case(2)
            <div class="row mt-3">
                <div class="col-lg-12 col-md-12">
                    <h5 class="text-truncate font-size-18 mb-1">{{$field->label}}</h5>
                    <input type="number" name="btnnumber-{{$field->id}}" id="btnnumber-{{$field->id}}" class="form-control" data-field-type="2" data-field-id="{{$field->id}}" data-field-label="{{$field->label}}" {{$field->required == 1 ? 'required' : ''}}>
                </div>
            </div>
            @break
        ...
        @case(3)
            <div class="row mt-3">
                <div class="col-lg-12 col-md-12">
                    <h5 class="text-truncate font-size-18 mb-1">{{$field->label}}</h5>
                    <input type="tel" name="btntel-{{$field->id}}" id="btntel-{{$field->id}}" class="form-control" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" size='10' data-field-type="3" data-field-id="{{$field->id}}" data-field-label="{{$field->label}}" {{$field->required == 1 ? 'required' : ''}}>
                </div>
            </div>
            @break
        ...
        @case(4)
            <div class="row mt-3">
                <div class="col-lg-12 col-md-12">
                    <h5 class="text-truncate font-size-18 mb-1">{{$field->label}}</h5>
                    <input type="email" name="btnemail-{{$field->id}}" id="btnemail-{{$field->id}}" class="form-control" pattern=".+@example\.com" size="30" data-field-type="4" data-field-id="{{$field->id}}" data-field-label="{{$field->label}}" {{$field->required == 1 ? 'required' : ''}}>
                </div>
            </div>
            @break
        ...
        @case(6)
            <div class="row mt-3">
                <div class="col-lg-6 col-md-12">
                    ...
                    @endphp
                    <select class="form-select" name="btnselect-{{$field->id}}" id="btnselect-{{$field->id}}" style="width: 100%;" data-field-type="6" data-field-id="{{$field->id}}" data-field-label="{{$field->label}}">
        ...
        @case(7)
            <div class="row mt-3">
                <div class="col-lg-6 col-md-12">
                    <h5 class="text-truncate font-size-18 mb-1">{{$field->label}}</h5>
                    <select class="form-select-multiple" name="btnselect-multiple-{{$field->id}}[]" id="btnselect-multiple-{{$field->id}}" style="width: 100%; height: 150px;" multiple="multiple" data-field-type="7" data-field-id="{{$field->id}}" data-field-label="{{$field->label}}">
                        @php
                            $options = $field->selectable[0];
                            $options = explode(',', $options);
                        @endphp
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="btn-group border border-primary d-flex flex-wrap" role="group" aria-label="Opciones">
                        @foreach($field->selectable as $options)
                            ...
                            @endphp
                            @foreach($options as $option)
                                <input type="radio" class="btn-check" id="option_{{ $field->id }}_{{ $option }}" name="option_{{ $field->id }}" value="{{ $option }}" data-field-type="{{$field->type}}" data-field-id="{{$field->id}}" data-field-label="{{$field->label}}">
