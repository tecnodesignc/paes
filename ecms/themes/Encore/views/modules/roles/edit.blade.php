...
{{--
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">{{ trans('user::roles.title.edit') }} - {{ $role->name }}</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">{{ trans('user::roles.title.edit') }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-12 d-none d-sm-flex align-items-center my-3">
                    <div class="ps-3">
                        <h4>{{ trans('user::roles.title.edit') }}</h4>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-body">
            {!! Form::open(['route' => ['user.role.update', $role->id], 'method' => 'put']) !!}
            <div class="row">
                <div class="col-md-12">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab_3-3" role="tab" aria-selected="false">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="tab-title">{{ trans('user::users.title.users') }}</div>
                                </div>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content py-3">
                        ...
                        <div class="tab-pane fade" id="tab_2-2" role="tabpanel">
                            @include('permissions.partials.permissions', ['model' => $role])
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h6>{{ trans('user::roles.title.users-with-roles') }}</h6>
                                            <ul>
